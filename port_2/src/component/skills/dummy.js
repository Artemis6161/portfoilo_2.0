...
<div className="skill">
 <div className=" flex topic">
 <div className="flex-items">Java Script</div>
      <div className="flex-items">React</div>
      <div className="flex-items">Jquery</div>
      <div className="icon1">
      <div className="flex-items">Python</div>
      <div className="flex-items">Firebase</div>
      </div></div>
      <div className="flex topic">
